...
$config["dbuser"] = "ora_bolmagd";			
$config["dbpassword"] = "a54403621";	
...
<body>
	...
	<h2>Delete Values into Player Table</h2>
	<p>Enter ALL</p>
	<form method="POST" action="player.php">
	...
	<h2>Update Values into Player Table</h2>
	...
	<h2>Display Tuples in Player Table</h2>
	...
	{ //prints results from a select statement
		echo "<br>Retrieved data from table Player Table:<br>";
		echo "<table>";
		echo "<tr><th>Player ID</th><th>Name</th></tr>";
	...
	function handleUpdateRequest()
	{
		...
		executeBoundSQL("UPDATE Player SET Name = :bind2 WHERE PlayerID = :bind1", $alltuples);
		oci_commit($db_conn);
	}
	...
	function handleDisplayRequest()
	{
		...
		if ($_GET['PlayerID'] == ''){
			...
			$result = executePlainSQL("SELECT * FROM Player WHERE PLAYERID = $playerID");
		}
